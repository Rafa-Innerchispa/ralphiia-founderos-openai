...
class Settings(BaseModel):
    ...
    remote_dev_vision_url: str = os.getenv("REMOTE_DEV_VISION_URL", "http://127.0.0.1:11434")
    remote_dev_vision_model: str = os.getenv("REMOTE_DEV_VISION_MODEL", "qwen2.5vl:7b")
