...
- Current status: FEMAR MCP flow and the first real supplier ingestion are verified on canonical staging `:8765`; 50/50 tests pass, 39 unique priced items are linked, and no production writes occurred
