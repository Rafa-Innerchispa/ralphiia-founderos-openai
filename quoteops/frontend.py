...
<body>
  ...
  <script>
    ...
    function renderDossier(data) {
      ...
      const workItem = data.work_item ? [`${data.work_item.task_id} · ${statusText(data.work_item.status)}`, data.work_item.next_action] : [];
